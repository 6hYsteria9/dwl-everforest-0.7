...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xd3c6aaff, 0x232a2eff, 0x232a2eff },
	[SchemeSel]  = { 0x232a2eff, 0xa7c080ff, 0x24283bff },
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_c,          spawn,          {.v = menucmd} },
	{ MODKEY,                    XKB_KEY_Return,     spawn,          {.v = termcmd} },
	{ MODKEY,                    XKB_KEY_f,          spawn,          SHCMD("firefox-wayland") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_S,          spawn,          SHCMD("grim -g \"$(slurp)\" - | wl-copy") },
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_O,          setlayout,      {.v = &layouts[4]} },
